...
namespace GrouperLib.Store
{
    internal class Ldap
    {
        ...
        public async IAsyncEnumerable<SearchResultEntry> GetObjectsAsync(string searchBase, string ldapFilter, System.DirectoryServices.Protocols.SearchScope searchScope, params string[] attributeList)
        {
